...
NTLM::NTLM(std::string text)
{
	this->_text = text;
}

std::string NTLM::ToLower(std::string text)
{
	std::string result;
...
std::string NTLM::hash(std::string text)
{
...
std::string NTLM::info(std::string text)
{
	std::string result = "Text : \"" + text + "\" NTLM : ";
	return result;
}

std::string NTLM::Name()
{
	std::string result = "NTLM";
	return result;
}